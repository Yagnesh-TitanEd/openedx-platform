...
def library_container_locator(
    ...
    return LibraryContainerLocator(
        library_key, container_type=container_type_code, container_id=container.entity_ref,  # TODO follow up
    )
...
def get_container_from_key(container_key: LibraryContainerLocator, include_deleted=False) -> Container:
    ...
    container = content_api.get_container_by_ref(learning_package.id, entity_ref=container_key.container_id)  # TODO follow up
